...
std::string cVAOManager::getBasePath()
{
    return this->m_basePathWithoutSlash;
}

void cVAOManager::LoadModelIntoVAOWithExistingModelPath(std::string friendlyName, std::string fileName, sModelDrawInfo& drawInfo, unsigned int shaderProgramID,
    bool bIsDynamicBuffer)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(sVertex) * drawInfo.numberOfVertices, (GLvoid*)drawInfo.pVertices, (bIsDynamicBuffer ? GL_DYNAMIC_DRAW : GL_STATIC_DRAW));
